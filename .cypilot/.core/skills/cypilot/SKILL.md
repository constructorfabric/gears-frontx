...
3. If `cpt` is missing and `~/.cypilot/cache/cpt-prompt-dismissed` does not exist, offer `pipx install git+https://github.com/constructorfabric/cyber-pilot.git`; on dismiss create the marker file
