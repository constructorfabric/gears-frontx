...
- [x] Installing a conforming template in a project makes its declared AI extensions agent-visible with no manual configuration step required in the consuming project.
