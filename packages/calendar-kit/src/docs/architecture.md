...
- **The host owns data and decisions** so one kit can serve products with different back ends, permission models and scheduling rules. Nothing product-specific lives in the kit; products reach in through slots, `metadata` and callbacks.
