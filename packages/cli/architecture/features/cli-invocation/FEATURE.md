...
- **ADR**: `cpt-frontx-adr-cli-internal-decomposition`, `cpt-frontx-adr-uniform-template-mechanism`, `cpt-frontx-adr-artifact-versioning-and-distribution`, `cpt-frontx-adr-uniform-cli-json-envelope`
