...
- **ADR**: `cpt-frontx-adr-cli-internal-decomposition`, `cpt-frontx-adr-template-classification`, `cpt-frontx-adr-artifact-versioning-and-distribution`
