...
- **ADR**: `cpt-frontx-adr-project-upgrade-mechanism`, `cpt-frontx-adr-single-project-state-file`, `cpt-frontx-adr-template-registration-and-origin-pinning`, `cpt-frontx-adr-uniform-cli-json-envelope`
- **Dependencies**:
