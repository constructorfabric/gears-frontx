...
- **ADR**: `cpt-frontx-adr-single-project-state-file`, `cpt-frontx-adr-template-ownership-boundary-declaration`, `cpt-frontx-adr-template-registration-and-origin-pinning`, `cpt-frontx-adr-assembly-conflict-prevention`, `cpt-frontx-adr-uniform-cli-json-envelope`
- **Dependencies**:
