...
**ADRs**: [Whole-Target Ownership Minus Declared and Project-Specific Exclusions](../../../architecture/ADR/0037-whole-target-ownership.md), [Template Manifest as the Published Conformance Contract](../../../architecture/ADR/0018-template-manifest-contract.md)
