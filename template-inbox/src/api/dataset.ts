...
export const conversations: Conversation[] = [
  ...
  },
  {
    ...
    contactId: 'r-22',
    snippet:
      'Snoozing this until you have upgraded the UI framework - ping me when ready and we will finish the migration.',
    ...
    tickets: [
      {
        id: 't-1041',
        number: '#1041',
        subject: 'v4 upgrade guide missing the UI framework step',
        openedAt: daysAgo(4),
        priority: 'medium',
        status: 'pending',
      },
