...
* **MAINT** — addressed: replacing a per-region declaration with a flat target-minus-exclusions model removes an entire class of merge-compatibility logic the tool no longer needs to maintain.
