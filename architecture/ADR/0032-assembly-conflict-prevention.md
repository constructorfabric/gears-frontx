...
* Good, because staging the whole assembly at once catches a conflict between any pair of applied templates, including a preset's referenced templates, not only conflicts with what is already present.
