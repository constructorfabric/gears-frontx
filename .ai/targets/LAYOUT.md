...
## SCOPE
- Layout slices are now part of `@gears-frontx/framework` (registered via layout plugin)
...
- REQUIRED: App logo icons (Gears FrontXLogoIcon) imported directly from @/app/icons/.
